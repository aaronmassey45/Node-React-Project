      ...
      <div className="card">
        <div className="card-body">
          ...
          <div className="dont-sue-me">
            I am in no way affiliated with Bob's Burgers. This is just a project
            for me to practice my web development skills. Enjoy yourself and
            don't get me sued!
          </div>
          <img
          ...
          <div className="content">
            ...
            Probably a lot of food fetishes out there. Don't be gross on here...
            Just mingle and have fun. But not too much fun.
          </div>
        </div>
      </div>
    </div>
